...
```bash
msd -o downloads 'https://pawchive.st/patreon/user/59577203'
```

Preview files without downloading:

```bash
msd --dry-run 'https://pawchive.st/patreon/user/59577203'
```
...
```bash
msd --kemono-thumbnails 'https://pawchive.st/patreon/user/59577203'
```
...
```text
downloads/kemono-patreon-pizzacakecomic/
  2026-06-18 - Rosalina Cosplay - 161451659 - 01 - Rosa1.png
  2026-06-18 - Rosalina Cosplay - 161451659 - 02 - Rosa2.png
  post-links.txt
```
